// shyam.cpp : Defines the entry point for the console application.
//
...
int level = 0, size = 1;
GLfloat color_array[][3] = {{1, 0, 0}, {0, 0, 1}, {0, 1, 0}, {1, 0, 1}, {1, 1, 0}, {0, 1, 1}};
...
GLfloat x_paddle, x_ball = 0, y_ball = -12, speed = 0, x_direction = 0, y_direction = 0, start = 0;
...
int main(int argc, char **argv)
{
    ...
    HWND win_handle = FindWindow(0,(LPCTSTR)"Balloon Popper Game");
    if (!win_handle==0)
    {
